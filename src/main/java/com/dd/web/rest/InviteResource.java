...
/**
 * REST controller for managing {@link com.dd.domain.Invite}.
 */
@RestController
@RequestMapping("/api")
public class InviteResource {
    ...
    public InviteResource(InviteService inviteService, InviteQueryService inviteQueryService) {
    ...
    public ResponseEntity<Invite> createInvite(@RequestBody Invite invite) throws URISyntaxException {
        ...
        Invite result = inviteService.save(invite);
     ...
     */
    @GetMapping("/invites")
    public ResponseEntity<List<Invite>> getAllInvites(InviteCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Invites by criteria: {}", criteria);
        Page<Invite> page = inviteQueryService.findByCriteria(criteria, pageable);
