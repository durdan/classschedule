...
/**
 * Criteria class for the {@link com.dd.domain.Teacher} entity. This class is used
 * in {@link com.dd.web.rest.TeacherResource} to receive all the possible filtering options from
...
public class TeacherCriteria implements Serializable, Criteria {
    ...
    private StringFilter profileContent;
    ...
    public TeacherCriteria(TeacherCriteria other) {
        ...
        this.profileContent = other.profileContent == null ? null : other.profileContent.copy();
    ...
    public StringFilter getProfileContent() {
        return profileContent;
    }

    public void setProfileContent(StringFilter profileContent) {
    ...
    public String toString() {
        return "TeacherCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (profileContent != null ? "profileContent=" + profileContent + ", " : "") +
