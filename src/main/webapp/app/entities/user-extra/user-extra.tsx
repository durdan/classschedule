  ...
  return (
    <div>
      <h2 id="user-extra-heading">
        <Translate contentKey="classscheduleApp.userExtra.home.title">User Extras</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="classscheduleApp.userExtra.home.createLabel">Create new User Extra</Translate>
        </Link>
      </h2>
        ...
        {userExtraList && userExtraList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('userType')}>
                  <Translate contentKey="classscheduleApp.userExtra.userType">User Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="classscheduleApp.userExtra.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userExtraList.map((userExtra, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{userExtra.userType}</td>
                  <td>{userExtra.user ? userExtra.user.email : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="classscheduleApp.userExtra.home.notFound">No User Extras found</Translate>
            </div>
          )
        )}
      </div>
