...
export const UserExtraDeleteDialog = (props: IUserExtraDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="classscheduleApp.userExtra.delete.question">
        <Translate contentKey="classscheduleApp.userExtra.delete.question" interpolate={{ id: userExtraEntity.id }}>
